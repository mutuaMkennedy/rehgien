...
class LeaderPanel extends Component {
  ...
  render() {
    //Returning a new array from leads containing claim field only
    ...
    var newUsersArray = [];
    //helper function for counting how many times a use id appears in claimers array
    function countClaims(array, value) {
      return array.reduce((s, a) => s + (Array.isArray(a) ? countClaims(a, value) : a === value), 0);
    }
    //helper function for counting how many times a use id appears in referals array
