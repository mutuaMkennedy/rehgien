          ...
          'alignItems':'top','backgroundColor':'#d0f3e969','padding':'10px'}}>
                 <Item>
                   <Item.Content>
                     ...
                     <Item.Meta>
                       <span className='rqplPropertyownership' style={{'fontSize':'13px'}}>{this.props.details.ownership}</span>
                     </Item.Meta>
                   </Item.Content>
                 </Item>
                 <Item>
          ...
          'alignItems':'top','backgroundColor':'#d0f3e969','padding':'10px' }}>
                ...
                <Item>
                  <Item.Content>
                    ...
                    <Item.Meta>
                      <span className='rqplPropertySize' style={{'fontSize':'13px'}}>{this.props.details.min_beds} - {this.props.details.max_beds}</span>
                    </Item.Meta>
                  </Item.Content>
                </Item>
                <Item>
