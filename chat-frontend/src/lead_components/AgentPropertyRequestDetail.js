...
function AgentPropertyRequestDetail() {
  ...
  useEffect(() => {
    async function fetchData(){
      try {
        const ag_lead_rq = await axios.get(`${base}/apis/markets/agent_property_request/${id}/ `);
  ...
  const handleClaim = (event) => {
    ...
    try {
        const claimLead = axios({
          method: "PATCH",
          url: `${base}/apis/markets/agent_property_request/${id}/cl_or_re/ `,
          data: {
            claimer:[tokenUserId],
          },
          config: {
                ...
                <CustomItemGroup relaxed='very'>
                       <Item>
                         <Item.Content>
                           ...
                           <Item.Meta>
                             <span className='rqplPropertyownership' style={{'fontSize':'13px'}}>Looking to {lead.ownership}</span>
                           </Item.Meta>
                         </Item.Content>
                       </Item>
                       <Item>
                ...
                <CustomItemGroup relaxed='very'>
                        ...
                        <Item>
                          <Item.Content>
                            ...
                            <Item.Meta>
                              <span className='rqplBeds' style={{'fontSize':'13px'}}>{lead.min_beds} - {lead.max_beds}</span>
                            </Item.Meta>
                          </Item.Content>
                        </Item>
                      <Item>
...
export default AgentPropertyRequestDetail;
